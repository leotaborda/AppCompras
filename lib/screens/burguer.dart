...
class BurguerScreen extends StatefulWidget {
  @override
  _BurguerScreenState createState() => _BurguerScreenState();
}

class _BurguerScreenState extends State<BurguerScreen> {
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text('$quantity Burger adicionado ao carrinho!'),
